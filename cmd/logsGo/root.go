...
func main() {
	...
	rootCmd.Flags().Int64Var(&cfg.MaxLogsInMem, "max-logs-in-mem", 10_000, "Maximum number of logs in memory before flushing to disk")
	...
	rootCmd.Flags().StringVar(&cfg.WebListenAddr, "web-listen-addr", ":19091", "LogsGo web client address")
