...
const file_logs_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"logs.proto\x12\x06logapi\"\xe3\x01\n" +
	"\bLogEntry\x12\x18\n" +
	"\aservice\x18\x01 \x01(\tR\aservice\x12\x14\n" +
	"\x05level\x18\x02 \x01(\tR\x05level\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\x12\x1c\n" +
	"\ttimestamp\x18\x04 \x01(\x03R\ttimestamp\x124\n" +
	"\x06labels\x18\x05 \x03(\v2\x1c.logapi.LogEntry.LabelsEntryR\x06labels\x1a9\n" +
...
var file_logs_proto_goTypes = []any{
	...
	nil,                    // 5: logapi.LogEntry.LabelsEntry
}
var file_logs_proto_depIdxs = []int32{
	5, // 0: logapi.LogEntry.labels:type_name -> logapi.LogEntry.LabelsEntry
	0, // 1: logapi.LogBatch.entries:type_name -> logapi.LogEntry
	0, // 2: logapi.Series.entry:type_name -> logapi.LogEntry
	3, // 3: logapi.SeriesBatch.entries:type_name -> logapi.Series
	0, // 4: logapi.LogIngestor.UploadLog:input_type -> logapi.LogEntry
	1, // 5: logapi.LogIngestor.UploadLogs:input_type -> logapi.LogBatch
	2, // 6: logapi.LogIngestor.UploadLog:output_type -> logapi.UploadResponse
	2, // 7: logapi.LogIngestor.UploadLogs:output_type -> logapi.UploadResponse
